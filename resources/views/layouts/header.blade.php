<header class="flex justify-between items-center py-3 px-6 bg-white border-b-4 border-indigo-600">
    ...
    <div class="flex items-center">
        ...
        -->
        <p class="text-lg mx-3"> {{ Auth::user()->usuario }}</p>
        ...
        <div x-data="{ dropdownOpen: false }"  class="relative">
            ...
            <div x-show="dropdownOpen" class="absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10">
                <a class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white hover:no-underline" href="{{ route('logout') }}"

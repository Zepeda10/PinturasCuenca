...
@section("body")
	...
	<div class="my-2">
		<div class="h-8 w-8 absolute my-2 items-center justify-center rounded-md">
			<a class="text-green-700 hover:text-green-600" href="{{route('verventas.index')}}">
		...
		<div class="h-8 w-8 absolute mx-32 my-2 items-center justify-center rounded-md">
			<a class="text-red-700 hover:text-red-600" href="{{route('verventas.pdf', $venta->id)}}">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm5 6a1 1 0 10-2 0v3.586l-1.293-1.293a1 1 0 10-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 11.586V8z" clip-rule="evenodd" />
				</svg>
				<span class="absolute -my-5 mx-6 font-semibold">PDF</span>
			</a>
		</div>
